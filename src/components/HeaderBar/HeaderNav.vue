<template>
  <div id="header-nav-wrap" class="header-nav-wrap">
    <div class="header-nav-main">
      <router-link to="/">
        <img class="logo-main" :src="imageUrlFor(logoLarge)" alt="Strong tower Installations Logo" />
        <img class="logo-small" :src="imageUrlFor(logoSmall)" alt="Strong tower Installations Logo" />
      </router-link>
      <HeaderMobileMenu />
